;;; vague-light-theme.el --- A warm, light, low contrast colorscheme for Emacs -*- lexical-binding: t; -*-

;; Author: spiperac
;; Based on vague-theme.el (dark variant)
;; Version: 1.0.0
;; Package-Requires: ((emacs "24.1"))

;;; Commentary:
;; Light variant of the vague theme
;; A warm, light, low contrast colorscheme. Pastel yet vivid, like a fleeting memory.

;;; Code:

(deftheme vague-light "A warm, light, low contrast colorscheme")

(let ((class '((class color) (min-colors 89)))
      ;; Light color palette - inverted and adjusted from vague.nvim
      (bg "#f5f5f0")
      (inactive-bg "#ebebde")
      (fg "#2e2e2e")
      (float-border "#a0a0a0")
...
(provide-theme 'vague-light)

;;; vague-light-theme.el ends here
